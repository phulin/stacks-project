...
theorem noetherian_iff_ideal_fg (R : Type u) [CommRing R] :
...
theorem localization_isNoetherian
    {R : Type u} [CommRing R] [IsNoetherianRing R] (S : Submonoid R) :
...
theorem tensorProduct_isNoetherian_of_finiteType_fieldExtension
    {k R K : Type u} [Field k] [CommRing R] [Field K]
...
noncomputable def localizationAwayToAtPrime
    {R : Type u} [CommRing R] (p : PrimeSpectrum R) (f : R)
    (hf : f ∉ p.asIdeal) :
