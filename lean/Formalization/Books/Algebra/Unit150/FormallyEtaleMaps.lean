...
/-- Chapter-facing names for the canonical associated-graded constructions of
Chapter 58.  The earlier API already supplies their multiplication,
ring, and graded-module structures. -/
abbrev associatedGradedPiece
    {R : Type u} [CommRing R] (I : Ideal R) (n : ℕ) : Type u :=
  associatedGradedRingPiece I n
