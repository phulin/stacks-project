...
quasi-coherent sheaf of ideals defining $Z$ in $U$. For $n \geq 1$
we can consider the closed subscheme $Z_n \subset U$
...
\noindent
These thickenings have the following universal property (which will assuage
...
\begin{proof}
Combining Lemmas \ref{lemma-formally-unramified-on-opens} and
\ref{lemma-affine-formally-unramified} we see that (1) $\Rightarrow$ (3).
It is immediate that (3) $\Rightarrow$ (4).
We have (4) $\Rightarrow$ (2) by Lemma \ref{lemma-affine-formally-unramified}.
If (2) holds, then $\Omega_{X/S}$ vanishes in a neighbourhood
of every point by Lemma \ref{lemma-formally-unramified-differentials}
(this also uses Morphisms, Lemma
\ref{morphisms-lemma-differentials-restrict-open}) whereupon
Lemma \ref{lemma-formally-unramified-differentials} tells us that $f$
...
\begin{proof}
Combining Lemmas \ref{lemma-formally-etale-on-opens} and
\ref{lemma-affine-formally-etale} we see that (1) $\Rightarrow$ (3).
It is immediate that (3) $\Rightarrow$ (4).
We have (4) $\Rightarrow$ (2) by Lemma \ref{lemma-affine-formally-etale}.
If (2) holds, then $\Omega_{X/S}$ and $\mathcal{C}_{X/S}$ vanish
in a neighbourhood of every point by
Lemma \ref{lemma-characterize-formally-etale}
(this also uses Morphisms, Lemma
\ref{morphisms-lemma-differentials-restrict-open} and
Lemma \ref{lemma-universal-thickening-localize}) whereupon
Lemma \ref{lemma-characterize-formally-etale} tells us that $f$
is formally unramified.
\end{proof}
...
By assumption the nilradical $\mathfrak p = \sqrt{(0)}$ of $A$
is a prime ideal.
...
\begin{proof}
Let $V = \Spec(A)$ be a nonempty affine open of $Y$.
By assumption the nilradical $\mathfrak p = \sqrt{(0)}$ of $A$ is a prime ideal.
...
(applied to the morphism $X_Z \to Z$)
implies that all fibres $X_y$ are not geometrically reduced
...
open, closed, and connected subsets of $X_y$ containing $s(y)$.
...
directed colimit of finite quasi-coherent $\mathcal{O}_S$-algebras
...
$$
Define a function $\beta_0 : X \to \mathbf{Z}$ sending
$s$ to $\dim_{\kappa(s)} A_s$.
By Varieties, Lemma
\ref{varieties-lemma-proper-geometrically-reduced-global-sections}
and the fact that $X_s$ is geometrically reduced
$A_s$ is finite product of finite separable extensions of $\kappa(s)$.
Hence $A_s \otimes_{\kappa(s)} \kappa(\overline{s})$ is a product
of $\beta_0(s)$ copies of $\kappa(\overline{s})$. Thus
$X_{\overline{s}}$ has $\beta_0(s)$ connected components.
In other words, we have $n_{X/S} = \beta_0$
