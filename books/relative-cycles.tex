...
Lemma \ref{lemma-weightings} is $n = p^f$ in this case.
\end{example}
...
Lemma \ref{lemma-action-closed} we have
...
(Lemma \ref{lemma-family-associated-closed}) this follows from
Lemma \ref{lemma-flat-pullback-as-action}.
\end{proof}
