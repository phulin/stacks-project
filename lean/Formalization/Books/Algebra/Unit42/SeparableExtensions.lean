...
/- The paired towers used by the textbook diagram.  Besides the compatible
   ...
   `k'(x^(1/p))`.  The cartesian invariant says that the top is generated by
   the comparison field and the image of the old top. -/
structure FinitePthRootBaseChangeTower
  ...
  comparison_generates_top :
    IntermediateField.adjoin comparisonUpper
        (Set.range (algebraMap K (finitePthRootFieldAtLevel top))) = ⊤
