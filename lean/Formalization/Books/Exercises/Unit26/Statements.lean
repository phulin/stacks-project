  ...
  · intro φ ψ h
    ...
    have hbranchY :
      ...
      have htorsionDS :
        ...
        let r : B⁰ :=
          ⟨∏ i, p i ^ e i,
            Finset.prod_ne_zero (fun i hi => pow_ne_zero _ (hp i).ne_zero)⟩
        refine ⟨r, ?_⟩
        ext i
      ...
      have hfinrankP :
        ...
        rw [Module.finrank_prod, Module.finrank_finsupp_self, htorsionDSzero,
          add_zero]
